...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        await handleLogin(email, contact, password)
        ...
        <div className="h-screen w-screen overflow-hidden bg-zinc-950 text-zinc-100 flex flex-col justify-center items-center px-4 py-4 font-sans selection:bg-amber-400 selection:text-zinc-950">
            ...
            <div className="w-full max-w-md space-y-4 relative z-10 my-auto">
                ...
                <div className="text-center space-y-1.5">
                    <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-amber-400/10 border border-amber-400/20 text-amber-400 mb-1">
                ...
                <div className="bg-zinc-900/70 backdrop-blur-xl border border-zinc-800/80 rounded-2xl p-6 sm:p-7 shadow-2xl shadow-black/50 space-y-4">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3.5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full mt-4 py-2.5 px-4 bg-amber-400 hover:bg-amber-300 active:scale-[0.99] text-zinc-950 font-semibold rounded-xl transition duration-200 flex items-center justify-center gap-2 shadow-lg shadow-amber-400/15 text-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                        >
                            {loading ? (
                                <>
                    ...
                    <div className="text-center pt-2 border-t border-zinc-800/60 text-xs text-zinc-400">
                        ...
                        <Link to="/register" className="text-amber-400 hover:underline font-medium ml-1">
                            Create an account
                        </Link>
                    </div>
                </div>
